...
import fracture.mod.planets.moons.kona.biome.gen.TrashHeapAtmosphereHandler;
...
public class ClientProxy extends Proxy {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(new TrashHeapAtmosphereHandler());
