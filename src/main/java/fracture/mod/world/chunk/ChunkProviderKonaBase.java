package fracture.mod.world.chunk;
...
public abstract class ChunkProviderKonaBase extends ChunkProviderCommon {
	
		protected static final IBlockState STONE = BlockInit.STONE_KONA.getDefaultState();
		...
		public ChunkProviderKonaBase(World worldIn, long seed, boolean mapFeaturesEnabled) {
			this.world = worldIn;
			...
			caveGenerator = TerrainGen.getModdedMapGen(new MapGenCaves(),
net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.CAVE);
		...
		public Chunk generateChunk(int x, int z) {
			...
			//kona logic
			this.buildSurfaceStructures(x, z, chunkprimer);
        ...
        protected abstract void buildSurfaceStructures(int x, int z, ChunkPrimer primer);
