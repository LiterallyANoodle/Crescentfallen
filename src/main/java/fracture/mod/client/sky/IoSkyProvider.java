...
public class IoSkyProvider extends IRenderHandler {
    ...
    // Horizon
    private float horizonR = 1.0F;
    private float horizonG = 0.6F;
    private float horizonB = 0.1F;
    ...
    public IoSkyProvider(IGalacticraftWorldProvider ioProvider) {
        this.sunSize = 17.5F * ioProvider.getSolarSize();
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        mc.renderEngine.bindTexture(earthTexture);
        worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
