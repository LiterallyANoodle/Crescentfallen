...
public class TitanSkyProvider extends IRenderHandler {
	...
	private static final ResourceLocation sunTexture = new ResourceLocation(CFInfo.ID, "textures/gui/celestialbodies/orbitalsun.png");
		...
		public TitanSkyProvider(IGalacticraftWorldProvider ceresProvider) {
		...
		public void render(float partialTicks, WorldClient world, Minecraft mc) {
			...
			f10 = this.sunSize;
			mc.renderEngine.bindTexture(TitanSkyProvider.sunTexture);
			...
			MCUtilities.getClient().renderEngine.bindTexture(TitanSkyProvider.overworldTexture);
			worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
